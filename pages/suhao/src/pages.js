import {
  ...
  tag,
  toolbar
} from "./components.js?v=20260703074251";
import { customerName, formatCurrency, leadName, siteName, userName } from "./data.js?v=20260703074251";
import { getAppPathname, navigate, queryParams, withQuery } from "./router.js?v=20260703074251";
import { canOperate, mutate, openDrawer, openModal, setSelectedRows, state, toast } from "./store.js?v=20260703074251";
import { loginAs, logout } from "./store.js?v=20260703074251";
...
export function DashboardPage() {
  ...
  return h("div", { class: "insight-page dashboard-layout" }, [
    searchPanel(
      [
...
export function MailPage() {
  ...
  const actions = [button("刷新", { iconName: "refresh", onClick: () => toast("邮件已刷新") }), button("批量 AI 提炼", { onClick: () => toast("已创建批量 AI 提炼任务") })];
  return h("div", {}, [
    searchPanel(
      [
      ...
      [
        ...
        button("重置", { onClick: () => toast("邮件筛选已重置") })
      ]
    ),
    toolbar(actions),
    h("div", { class: "mail-shell" }, [
      ...
      selected
        ? h("div", { class: "mail-detail" }, [
            h("strong", { class: "content-title" }, selected.subject),
            infoGrid([
...
export function WhatsappPage() {
  ...
  const actions = [button("刷新", { iconName: "refresh", onClick: () => toast("会话已刷新") })];
  return h("div", {}, [
    searchPanel(
      [
      ...
      [button("查询", { variant: "primary", iconName: "search", onClick: () => toast("会话筛选已更新") }), button("重置", { onClick: () => toast("会话筛选已重置") })]
    ),
    toolbar(actions),
    h("div", { class: "whatsapp-shell" }, [
      ...
      h("div", { class: "conversation-detail" }, [
        h("strong", { class: "content-title" }, selected.contact),
        infoGrid([
...
export function SalesAnalyticsPage() {
  return h("div", { class: "insight-page analysis-layout" }, [
  ...
  return h("div", {}, [
    ...
    h("div", { class: "role-shell" }, [
      ...
      h("div", { class: "section-body" }, [
        ...
        h("strong", { class: "content-title" }, selectedRole.name),
...
function logTable(type) {
  ...
  return h("div", {}, [
    ...
    toolbar([button("导出", { iconName: "export", onClick: () => toast("已创建日志导出任务") })]),
    dataTable({
      selectable: false,
...
function listPage({ title, desc, breadcrumbs, actions, fields, table, extraTop }) {
  ...
  return h("div", { class: "auth-page" }, [
    h("div", { class: "auth-card" }, [
      ...
      h("div", { class: "auth-row" }, [
        h("label", {}, [h("input", { type: "checkbox", checked: true }), "记住密码"]),
