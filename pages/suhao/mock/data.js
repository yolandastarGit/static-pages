window.CRM_MOCK = {
  ...
  systemConfig: [
    { id: "sc01", name: "AI 能力总开关", code: "aiMaster", value: true, desc: "全局启用/停用 AI 能力。关闭后 AI 能力管理页仍可见，但所有 AI 业务场景不再调用 AI。不控制 Apollo。" },
    ...
    { id: "sc04", name: "AI 自动提取企业信息", code: "aiExtractCompany", value: false, desc: "一期闲置：客户画像·企业工商信息改由 Apollo enrichment，不再作为画像企业块门槛。" },
  ...
  // 客户画像·企业块：Apollo Organization Enrichment（方案 A）；参展/风险一期空（§7.9）
  companyProfiles: [
    {
      domain: "aeromex-parts.com",
      company: "AeroMex Precision Parts S.A. de C.V.",
      shortName: "AeroMex Precision",
      websiteUrl: "https://www.aeromex-parts.com",
      primaryDomain: "aeromex-parts.com",
      linkedinUrl: "",
      industry: "航空零部件 / CNC 精密加工",
      foundedAt: "2014",
      location: "Mexico City, Mexico",
      scale: "约 280 人",
      intro: "墨西哥航空与工业零部件采购商，长期服务北美装配工厂，具备稳定季度采购计划。",
    ...
    },
    {
      ...
      shortName: "PlayNorth",
      websiteUrl: "https://www.playnorth.co",
      primaryDomain: "playnorth.co",
      linkedinUrl: "",
      industry: "玩具零售 / 私标礼品",
      foundedAt: "2017",
      location: "Ontario, Canada",
      scale: "约 120 人",
      intro: "北美零售活动礼品采购商，主要面向连锁商超和节日活动渠道，采购节奏受活动节点驱动。",
    ...
    },
    {
      ...
      location: "Dubai, UAE",
      scale: "约 90 人",
      intro: "中东礼品与玩具渠道采购商，服务海湾地区零售门店及活动礼品项目。",
    ...
    },
    {
      ...
      websiteUrl: "https://www.meyer-automation.example",
      primaryDomain: "meyer-automation.example",
      linkedinUrl: "",
      industry: "自动化设备 / 精密五金",
      foundedAt: "2011",
      location: "Munich, Germany",
      scale: "约 210 人",
      intro: "德国自动化设备制造企业，长期采购机械五金支架及定制结构件。",
...
(() => {
  ...
  appendById("aiProviders", [
    ...
    { id: "aip05", name: "DeepSeek", capabilityName: "DeepSeek-企业信息提取（闲置）", type: "大语言模型", defaultModel: "DeepSeek-Chat", businessScene: [], status: "停用", updatedAt: "2026-07-22 11:00", config: providerConfig("DeepSeek", "DeepSeek-Chat", false) },
