window.CRMRouter = {
  routes: {
    ...
    siteOperationData: "ai.html?view=site-operation-data",
    ai: "ai.html?view=ai",
  ...
  meta: {
    ...
    b2bChat: { title: "b2b 聊天记录", page: "b2bChat", parent: "沟通中心", keepAlive: true },
  ...
  currentKey(basePage) {
    ...
    const map = {
      ...
      ai: {
        sites: "sites",
        "site-operation-data": "siteOperationData",
        ai: "ai",
